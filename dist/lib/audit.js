 ...
 */
export async function createServerAuditLog({ userId, action, details, requestInfo = { ipAddress: "unknown", userAgent: "unknown" }, type = "activity" }) {
    try {
 ...
 */
export async function createAuditLog(action, details, type = "activity") {
    try {

import { SQSClient, SendMessageCommand, ReceiveMessageCommand, DeleteMessageCommand, DeleteMessageBatchCommand, SendMessageBatchCommand } from '@aws-sdk/client-sqs';
 ...
 */
export async function sendBatchToNotificationQueue(messages) {
    if (!messages.length)
 ...
 */
export async function deleteBatchFromQueue(receiptHandles) {
    if (!receiptHandles.length)
        return;
    try {

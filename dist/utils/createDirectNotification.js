 ...
 */
export async function createDirectNotifications(type, title, body, userIds, actionUrl, data) {
 ...
 */
export async function createDirectNotification(userId, type, title, body, actionUrl, data) {
    try {

 ...
 */
export async function trackNotificationEvent(notificationId, event, metadata) {
    try {
 ...
 */
export async function getNotificationStats(startDate, endDate, type) {
    const where = {};
 ...
 */
export async function getNotificationEventHistory(notificationId) {
...
export async function markNotificationDelivered(notificationId, metadata) {
    return trackNotificationEvent(notificationId, NotificationEventType.DELIVERED, metadata);
}
/**
 * Track when a user clicks on a notification
 */
export async function trackNotificationClick(notificationId, metadata) {
    try {
        // Record the click event
        await trackNotificationEvent(notificationId, NotificationEventType.CLICKED, metadata);

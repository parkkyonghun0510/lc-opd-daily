...
async function fixReportComments() {
  ...
  try {
    ...
    if (!result || result.length === 0) {
      console.log('The parentId column does not exist in the ReportComment table. Adding it...');
      ...
      console.log('The parentId column already exists in the ReportComment table');
    }

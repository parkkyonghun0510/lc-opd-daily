...
describe('ProtectedRoute', () => {
  ...
  it('should render loading component when loading', () => {
    ...
    // Render component
    render(
      <ProtectedRoute loadingComponent={<div data-testid="loading-content">Loading...</div>}>
        <div data-testid="protected-content">Protected Content</div>
      </ProtectedRoute>
    );
  ...
  it('should check all permissions when requireAll is true', () => {
    ...
    render(
      <ProtectedRoute permissions={['VIEW_REPORTS', 'EDIT_REPORTS']} requireAll={true}>
        <div data-testid="protected-content">Protected Content</div>
      </ProtectedRoute>
    );
  ...
  it('should check any permission when requireAll is false', () => {
    ...
    render(
      <ProtectedRoute permissions={['VIEW_REPORTS', 'EDIT_REPORTS']} requireAll={false}>
        <div data-testid="protected-content">Protected Content</div>
      </ProtectedRoute>
    );

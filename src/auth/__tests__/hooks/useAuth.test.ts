...
describe('Auth Hooks', () => {
  ...
  describe('useAuth', () => {
    ...
    it('should call login with the correct parameters', () => {
      ...
      expect(mockStore.login).toHaveBeenCalledWith('test@example.com', 'password', '/dashboard');
    });
  ...
  describe('useUserProfile', () => {
    ...
    it('should call updateProfile with the correct parameters', () => {
      ...
      expect(mockStore.updateProfile).toHaveBeenCalledWith({ name: 'Updated User' });
    });
  ...
  describe('usePermissions', () => {
    ...
    it('should call hasAnyPermission from canAny', () => {
      ...
      const hasAnyPermissionSpy = jest.spyOn(result.current, 'hasAnyPermission');
      ...
      expect(hasAnyPermissionSpy).toHaveBeenCalledWith(['VIEW_REPORTS', 'EDIT_REPORTS']);
    });
    ...
    it('should call hasAllPermissions from canAll', () => {
      ...
      const hasAllPermissionsSpy = jest.spyOn(result.current, 'hasAllPermissions');
      ...
      expect(hasAllPermissionsSpy).toHaveBeenCalledWith(['VIEW_REPORTS', 'EDIT_REPORTS']);
    });

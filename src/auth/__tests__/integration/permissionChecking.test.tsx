  ...
  return (
    <div>
      ...
      <div data-testid="any-permission">
        {hasAnyPermission(["VIEW_REPORTS", "EDIT_REPORTS"])
          ? "Has Any Permission"
          : "Has No Permission"}
      </div>

      <div data-testid="all-permissions">
        {hasAllPermissions(["VIEW_REPORTS", "EDIT_REPORTS"])
          ? "Has All Permissions"
      ...
      <PermissionGate
        ...
        fallback={
          <div data-testid="permission-gate-fallback">Access Denied</div>
        }
      >
...
describe("Permission Checking Integration", () => {
  ...
  it("should check individual permissions correctly", () => {
    ...
    expect(screen.getByTestId("view-reports")).toHaveTextContent(
      "Can View Reports",
    );
    expect(screen.getByTestId("edit-reports")).toHaveTextContent(
      "Cannot Edit Reports",
    );
  });
  ...
  it("should check any permissions correctly", () => {
    ...
    expect(screen.getByTestId("any-permission")).toHaveTextContent(
      "Has Any Permission",
    );
  });
  ...
  it("should check all permissions correctly", () => {
    ...
    expect(screen.getByTestId("all-permissions")).toHaveTextContent(
      "Missing Some Permissions",
    );
  });
  ...
  it("should check branch access correctly", () => {
    ...
    expect(screen.getByTestId("branch-access")).toHaveTextContent(
      "Has Branch Access",
    );
  });
    ...
    render(
      <div>
        ...
        <PermissionGate
          ...
          requireAll={true}
          fallback={
            <div data-testid="all-required-fallback">
        ...
        <PermissionGate
          ...
          requireAll={false}
          fallback={
            <div data-testid="any-required-fallback">
  ...
  it("should handle role and branch access together", () => {
    ...
    render(
      <div>
        <PermissionGate roles={["BRANCH_MANAGER"]} branchId="branch-1">

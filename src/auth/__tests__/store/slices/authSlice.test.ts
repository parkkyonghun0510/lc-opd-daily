...
describe('AuthSlice', () => {
      ...
      const errorTests = [
        {
          ...
          expected: 'Your account has no branch assigned. Please contact your administrator.'
        },
        {
          error: 'Account is inactive',
          expected: 'Your account is inactive. Please contact your administrator.'
        },
        {
          error: 'Invalid credentials',
  ...
  describe('logout', () => {
    ...
    it('should clear user data and update state on logout', async () => {
      // Mock user data
      store.user = { id: '1', name: 'Test User', email: 'test@example.com', role: 'USER' };
  ...
  describe('selectors', () => {
    describe('isAdmin', () => {
      it('should return true if user role is ADMIN', () => {
        ...
        store.user = { id: '1', name: 'Admin User', email: 'admin@example.com', role: 'ADMIN' };
      ...
      it('should return false if user role is not ADMIN', () => {
        ...
        store.user = { id: '1', name: 'Regular User', email: 'user@example.com', role: 'USER' };
    ...
    describe('isBranchManager', () => {
      it('should return true if user role is BRANCH_MANAGER', () => {
        ...
        store.user = { id: '1', name: 'Manager', email: 'manager@example.com', role: 'BRANCH_MANAGER' };

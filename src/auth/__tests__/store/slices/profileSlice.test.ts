import { createProfileSlice, ProfileSlice } from '@/auth/store/slices/profileSlice';
...
describe('ProfileSlice', () => {
  ...
  describe('fetchProfile', () => {
    ...
    it('should handle exceptions', async () => {
      ...
      (fetchUserData as jest.Mock).mockRejectedValue(new Error('Network error'));
  ...
  describe('updatePreferences', () => {
    ...
    it('should handle exceptions', async () => {
      ...
      (updateUserPreferences as jest.Mock).mockRejectedValue(new Error('Network error'));

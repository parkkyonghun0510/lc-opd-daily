            ...
            try {
                if ('performance' in window) {
                    ...
                    const metrics: PerformanceMetrics = {
                        ...
                        timeToInteractive: navigationTiming.domInteractive - navigationTiming.requestStart,
                        firstContentfulPaint: paintTimings.find(entry => entry.name === 'first-contentful-paint')?.startTime || 0,

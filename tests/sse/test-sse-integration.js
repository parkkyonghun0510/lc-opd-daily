...
async function testSSEIntegration() {
  ...
  await sendRequest(
    "/trigger-event?type=notification&message=New%20report%20available&userId=user-123",
  );
  ...
  await sendRequest(
    "/api/simulate-system-alert?type=warning&message=System%20maintenance%20in%2015%20minutes",
  );

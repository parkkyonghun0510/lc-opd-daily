...
async function testBranchFiltering() {
  ...
  console.log(
    "API call: GET /api/reports?branchId=inaccessible-branch&reportType=plan",
  );
  ...
  console.log(
    "7. Verify that reports from all accessible branches are returned",
  );
  console.log("8. Select a specific branch in the branch selector");
  console.log("9. Check the network request to /api/reports");
  console.log(
    "10. Verify that only reports from the selected branch are returned",
  );
}
